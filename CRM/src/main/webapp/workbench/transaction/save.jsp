 ...
 */
	...
	$(function () {
		...
		$("#create-stage").change(function () {
			...
			/*  	由于stage是一个可变的变量
					无法用json.key的形式取得value
					需要用json[key]的方式取值		 */
			var possiblity = json[stage]
...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="百度推广1">
				<input type="hidden" value="832831cc55e94a0fbd76d154a0bcbd0c" name="activityId"/>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="汪苏泷">
				<input type="hidden" value="b3f51906b7004a91815d49025bb95918" name="contactsId"/>
			</div>
		</div>
