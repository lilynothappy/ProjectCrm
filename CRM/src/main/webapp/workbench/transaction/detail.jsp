...
<%@ page import="com.lynn.crm.settings.domain.DicValue" %>
<%@ page import="java.util.Map" %>
<%@ page import="java.util.Set" %>
<%@ page import="com.lynn.crm.workbench.domain.Tran" %>
...
<script type="text/javascript">
	...
	function changeStage(stage,i) {
		...
		$.ajax({
			...
			success:function (data) {
				if(data.success){
					//html()用于输出div与span标签中的值，val()用于输出input等文本类中的值
