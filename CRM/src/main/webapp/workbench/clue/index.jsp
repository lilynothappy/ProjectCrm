...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#clueBody").on("click",$(":checkbox"),function () {
			//$("#selectAll").prop("checked",$(":checkbox").length-1==$(":checkbox:checked").length)
			//以上方法因为同一个页面中还有一个全选的checkbox而无法执行
	...
	function pageList(pageNo,pageSize) {
		...
		$("#search-fullname").val($.trim($("#search-fullname").val()));
		$("#search-company").val($.trim($("#search-company").val()));
		$("#search-phone").val($.trim($("#search-phone").val()));
		$("#search-source").val(source);
		$("#search-owner").val($.trim($("#search-owner").val()));
		$("#search-mphone").val($.trim($("#search-mphone").val()));
